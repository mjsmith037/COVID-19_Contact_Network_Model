...
intelligently_assign_ages <- function(node_df) {
  ...
  age_distribution <- read_csv("www/data/age_demographics.csv", skip=1, col_types="cd")
...
generate_contact_network <- function(number_of_households=100,
  ...
  household_size_distribution <-
    read_csv("www/data/HouseholdSizeData_CensusTableHH-4.csv",
  ...
  case_fatality_distribution <- read_csv("www/data/case_fatality.csv", skip=1, col_types="cccc") %>%
